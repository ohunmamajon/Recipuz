...
struct Recipes  {
    struct Plov{
        ...
        static let cookingGuide = [CookingGuide(step: 1, guide: "Yogni qzit"), CookingGuide(step: 2, guide: "Piyozni qovur"), CookingGuide(step: 3, guide: "goshtni qovur"), CookingGuide(step: 1, guide: "Sabzini qovur")]
    }
